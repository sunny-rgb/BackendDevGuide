...
| 优先级 | 算法模块 | 题数 | 涉及题目 |
| :--: | :--- | :--: | :--- |
| ⭐⭐⭐ | 🔗 链表 | 5 道 | [环形链表](#6. ⭐⭐⭐环形链表 ✅✅😅)、[环形链表 II](#14. ⭐⭐⭐环形链表2 ✅😅)、[相交链表](#3. ⭐⭐ 相交链表 ✅✅😅)、[两数相加](#15. ⭐⭐⭐两数相加 ✅😅)、[排序链表](#18. ⭐⭐⭐⭐⭐⭐排序链表 ✅😅) |
| ⭐⭐⭐ | 📊 动态规划 | 6 道 | [零钱兑换](#⭐⭐⭐⭐⭐零钱兑换 ✅😅)、[最长公共子序列](#⭐⭐⭐⭐⭐ 最长公共子序列 ✅😅)、[爬楼梯](#⭐ 爬楼梯 ✅😅)、最长有效括号、分割等和子集、[最小路径和](#⭐⭐⭐ 最小路径和 ✅😅) |
| ⭐⭐⭐ | 🔍 二分查找 | 4 道 | [搜索旋转排序数组](#⭐⭐⭐⭐⭐ 搜索旋转排序数组  ✅😅)、[在排序数组中查找元素](#⭐⭐⭐⭐⭐ 在排序数组中查找元素的第一个和最后一个位置  ✅😅)、寻找最小值、中位数 |
| ⭐⭐ | 🌲 二叉树 | 3 道 | [二叉树右视图](#25. ⭐⭐⭐⭐⭐二叉树的右视图 ✅😅) ✅、[最大路径和](#⭐⭐⭐⭐⭐ 二叉树中的最大路径和 ✅😅)、[BST 第 K 小元素](#24. ⭐⭐二叉搜索树中第 K 小的元素 ✅😅) |
| ⭐⭐ | 🔁 回溯 | 2 道 | [全排列](#⭐⭐⭐⭐⭐ 全排列 ✅😅)、括号生成 |
| ⭐⭐ | 🪟 滑动窗口 | 2 道 | [滑动窗口最大值](#⭐⭐⭐⭐⭐⭐⭐滑动窗口最大值✅😅)、[最小覆盖子串](#⭐⭐⭐⭐⭐⭐⭐最小覆盖子串✅😅) |
| ⭐⭐ | 🟦 矩阵 | 2 道 | [螺旋矩阵](#⭐⭐⭐⭐⭐ 螺旋矩阵  ✅😀)、[搜索二维矩阵 II](#⭐⭐⭐⭐⭐ 搜索二维矩阵2  ✅😀) |
| ⭐ | 📦 数组 / 哈希 / 堆 | 3 道 | [两数之和](#⭐ 两数之和  ✅😅) ✅、[寻找重复数](#35. ⭐⭐⭐⭐⭐⭐ 寻找重复数 ✅😅)、前 K 个高频元素 |
| ⭐ | 📚 栈 | 2 道 | 字符串解码、最小栈 |
| ⭐ | 🕸️ 图 | 1 道 | 课程表 |
...
| :--: | :--- | :--- | :--: | :--: |
| 1 | 哈希 | 字母异位词分组 | 🟡 Medium | 🟠 |
| 2 | 双指针 | [移动零](#36. ⭐ 移动零  ✅😅) | 🟢 Easy | 🟠 |
| 3 | 滑动窗口 | [找所有字母异位词](#找到字符串中所有字母异位词 ❌😅) | 🟡 Medium | 🟠 |
| 4 | 普通数组 | 除自身以外数组的乘积 | 🟡 Medium | 🟠 |
| 5 | 矩阵 | [矩阵置零](#⭐⭐⭐⭐矩阵置零✅😅) | 🟡 Medium | 🟠 |
| 6 | 链表 | [随机链表的复制](#17. ⭐⭐⭐⭐⭐⭐随机链表的复制 ✅😅) | 🟡 Medium | 🟠 |
| 7 | 二叉树 | [有序数组转 BST](#22. ⭐⭐将有序数组转换为二叉搜索树 ✅😅) | 🟢 Easy | 🟠 |
| 8 | 二叉树 | [二叉树展开为链表](#⭐⭐⭐⭐⭐二叉树展开为链表 ✅😅) | 🟡 Medium | 🟠 |
| 9 | 二叉树 | [路径总和 III](#⭐⭐⭐⭐⭐路径总和3 ✅😅) | 🟡 Medium | 🟠 |
| 10 | 图论 | 实现 Trie | 🟡 Medium | 🟠 |
| 11 | 回溯 | 分割回文串 | 🟡 Medium | 🟠 |
| 12 | 回溯 | N 皇后 | 🔴 Hard | 🟠 |
| 13 | 贪心算法 | 跳跃游戏 II | 🟡 Medium | 🟠 |
| 14 | 贪心算法 | 划分字母区间 | 🟡 Medium | 🟠 |
| 15 | 动态规划 | [杨辉三角](#⭐⭐⭐ 杨辉三角  ✅😅) | 🟢 Easy | 🟠 |
| 16 | 动态规划 | 完全平方数 | 🟡 Medium | 🟠 |
| 17 | 栈 | 柱状图中最大的矩形 | 🔴 Hard | 🟠 |
| 18 | 二分查找 | [搜索插入位置](#⭐⭐ 搜索插入位置（二分查找）  ✅😀) | 🟢 Easy | 🟠 |
| 19 | 二分查找 | [搜索二维矩阵](#⭐⭐⭐ 搜索二维矩阵  ✅😀) | 🟡 Medium | 🟠 |
| 20 | 技巧 | [只出现一次的数字](#31. ⭐⭐只出现一次的数字✅😅) | 🟢 Easy | 🟠 |

### 2.5 ❄️ 冷门参考｜Hot100 中 2.1~2.4 未覆盖的剩余题目（约 30 道）

不在 2.1~2.4 必刷清单中，但属于 Hot100 完整体系；备考时间充裕时补充刷题。

| 序号 | 类别 | 题目 | 难度 | 完成情况 |
| :--: | :--- | :--- | :--: | :--: |
| 1 | 哈希 | [最长连续序列](#⭐⭐⭐⭐⭐ 最长连续序列  ✅😅) | 🟡 Medium | 🟠 |
| 2 | 双指针 | [盛最多水的容器](#37. ⭐⭐⭐⭐ 盛最多水的容器  ✅😅) | 🟡 Medium | 🟠 |
| 3 | 子串 | 和为 K 的子数组 | 🟡 Medium | 🟠 |
| 4 | 普通数组 | 轮转数组 | 🟡 Medium | 🟠 |
| 5 | 普通数组 | 缺失的第一个正数 | 🔴 Hard | 🟠 |
| 6 | 矩阵 | [旋转图像](#⭐⭐⭐⭐⭐ 旋转图像  ✅😀) | 🟡 Medium | 🟠 |
| 7 | 链表 | [回文链表](#5. ⭐⭐⭐⭐⭐回文链表 ✅✅😅) | 🟢 Easy | 🟠 |
| 8 | 链表 | [两两交换链表中的节点](#11. ⭐⭐⭐⭐⭐两两交换链表中的节点 ✅😅) | 🟡 Medium | 🟠 |
| 9 | 二叉树 | [二叉树的中序遍历](#7. ⭐⭐⭐二叉树的中序遍历 ✅✅😅) | 🟢 Easy | ✅ |
| 10 | 二叉树 | [二叉树的最大深度](#8. ⭐⭐二叉树的最大深度 ✅✅😅) | 🟢 Easy | ✅ |
| 11 | 二叉树 | [翻转二叉树](#9. ⭐⭐ 翻转二叉树✅✅😅) | 🟢 Easy | 🟠 |
| 12 | 二叉树 | [对称二叉树](#10. ⭐⭐⭐⭐⭐对称二叉树 ✅✅😅) | 🟢 Easy | 🟠 |
| 13 | 二叉树 | [二叉树的直径](#20. ⭐⭐⭐⭐⭐二叉树的直径 ✅😅) | 🟢 Easy | 🟠 |
| 14 | 二叉树 | [验证二叉搜索树](#23. ⭐⭐⭐⭐⭐验证二叉搜索树 ✅😅) | 🟡 Medium | 🟠 |
| 15 | 二叉树 | [从前序与中序遍历序列构造二叉树](#⭐⭐⭐⭐⭐从前序与中序遍历序列构造二叉树 ✅😅) | 🟡 Medium | 🟠 |
| 16 | 图论 | 腐烂的橘子 | 🟡 Medium | 🟠 |
| 17 | 回溯 | [子集](#⭐⭐⭐⭐⭐ 子集 ✅😅) | 🟡 Medium | 🟠 |
| 18 | 回溯 | [组合总和](#⭐⭐⭐⭐⭐ 组合总和 ✅😅) | 🟡 Medium | 🟠 |
| 19 | 回溯 | 电话号码的字母组合 | 🟡 Medium | 🟠 |
| 20 | 回溯 | 单词搜索 | 🟡 Medium | 🟠 |
| 21 | 贪心 | 跳跃游戏 | 🟡 Medium | 🟠 |
| 22 | 动态规划 | [打家劫舍](#⭐⭐⭐⭐⭐打家劫舍 ✅😅) | 🟡 Medium | 🟠 |
| 23 | 动态规划 | 单词拆分 | 🟡 Medium | 🟠 |
| 24 | 动态规划 | 乘积最大子数组 | 🟡 Medium | 🟠 |
| 25 | 动态规划 | 不同路径 | 🟡 Medium | 🟠 |
| 26 | 栈 | 每日温度 | 🟡 Medium | 🟠 |
| 27 | 堆 | 数据流的中位数 | 🔴 Hard | 🟠 |
| 28 | 技巧 | [多数元素](#32. ⭐⭐ 多数元素 ✅😅) | 🟢 Easy | 🟠 |
| 29 | 技巧 | [颜色分类](#33. ⭐⭐⭐⭐⭐ 颜色分类 ✅😅) | 🟡 Medium | 🟠 |
| 30 | 技巧 | [下一个排列](#34. ⭐⭐⭐⭐⭐⭐ 下一个排列 ✅😅) | 🟡 Medium | 🟠 |
